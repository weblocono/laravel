              ...
              @foreach ($articals as $artical)
                ...
                <div class="blog-post">
                  ...
                  <div class="down-content">
                    <span>{{ $artical->theme }}</span>
                    <a href="{{ route('postDetails', $artical->slug ) }}"><h4>{{ $artical->title }}</h4></a>
                    <ul class="post-info">
                      <li><a href="#">{{ $artical->author()->username }}</a></li>
                      <li><a href="#">{{ $artical->created_at->format('M d, Y') }}</a></li>
                      <li><a href="#">12 Comments</a></li>
                    </ul>
                    <p>{{ mb_substr($artical['content'], 0, 300) }}...</p>
